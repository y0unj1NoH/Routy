export const UI_COPY = {
  ...
  common: {
    ...
    error: {
      ...
      supportCodeLabel: (code: string) => `에러 코드: ${code}`,
      invalidTripDate: "여행 날짜를 다시 확인해 주세요",
      invalidTripDuration: (maxDays: number) => `여행 기간은 최대 ${maxDays}일까지 설정할 수 있어요`,
      invalidPlaceListSelection: "선택한 리스트를 다시 불러와 주세요",
      regenerateDateRangeRequired: "여행 날짜를 다시 선택해 주세요",
      invalidScheduleStopMove: "일정을 이동할 위치를 다시 선택해 주세요",
      invalidScheduleEdit: "일정 편집 내용을 다시 불러와 주세요",
      ...
      googleMapsListLinkRequired: "Google Maps 저장 리스트 링크를 다시 확인해 주세요",
      googleMapsPlaceLinkRequired: "Google Maps 장소 상세 링크를 다시 확인해 주세요",
      googleMapsListItemLimitExceeded: (limit: number) =>
        `Google Maps 저장 리스트는 최대 ${limit}개 장소까지만 가져올 수 있어요`,
      placeListItemLimitExceeded: (limit: number) => `리스트에는 최대 ${limit}개 장소까지 담을 수 있어요`,
      aiCandidateLimitExceeded: (limit: number) => `AI 일정 생성에는 최대 ${limit}개 장소까지 사용할 수 있어요`,
      schedulePlaceListEmpty: "선택한 리스트에 일정으로 만들 장소가 없어요",
      scheduleNoSchedulablePlaces: "숙소를 제외하면 일정으로 만들 수 있는 장소가 없어요. 다른 장소를 더 추가해 주세요",
      scheduleCandidatesEmptyAfterPreprocess: "장소를 다시 확인해 주세요. 일정으로 만들 수 있는 장소가 부족해요",
      stayPlaceNotInList: "선택한 숙소가 저장 리스트에 없어요. 다시 선택해 주세요",
      stayPlaceDataMissing: "선택한 숙소 정보를 다시 불러와 주세요",
  ...
  saved: {
    ...
    detail: {
      ...
      deleteBlockedBySchedulesError: "이 리스트로 만든 일정이 남아 있어 삭제할 수 없어요. 먼저 일정을 삭제해 주세요",
